                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($translationProgress as $entry)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress">
                                                        <div ng-class="{'progress-bar': true, 'progress-bar-warning': 0.8 <= {{$entry->count / $baseStringCounts[$entry->project_id]}} < 1 , 'progress-bar-success': {{$entry->count / $baseStringCounts[$entry->project_id]}} >= 1}" role="progressbar" aria-valuenow="60"
                                                             aria-valuemin="0"
                                                             aria-valuemax="100"
