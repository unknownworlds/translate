                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($translationProgress as $entry)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress">
                                                        <div ng-class="{'progress-bar': true, 'progress-bar-warning': {{$entry->count / $baseStringCounts[$entry->project_id]}} >= 0.025, 'progress-bar-success': {{$entry->count / $baseStringCounts[$entry->project_id]}} >= 0.08}" role="progressbar" aria-valuenow="60"
                                                             aria-valuemin="0"
                                                             aria-valuemax="100"
